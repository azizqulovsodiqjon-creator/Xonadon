"use strict";
  ...
  var t = {
    ...
    EN:{sotuv:"Sale", ijara:"Rent", kunlik:"Daily", search:"Search... (title, district)", post_ad:"Post an ad", admin:"Admin", on_map:"On map", filters:"Filters", type_all:"All types", kvartira:"Apartment", hovli:"House/dacha", tijorat:"Commercial", yer:"Land", owner:"By owner", mortgage:"Mortgage OK", last_week:"Last week", last_month:"Last month",
      ...
      hero_eyebrow:"Straight from the owner, verified listings", hero_title_1:"Your home is out there.", hero_title_2:"Finding it is", hero_title_em:"the easy part.", hero_sub:"Apartments, houses, commercial spaces and land across Jizzax region — all in one place. Admin-verified, from trusted sellers.", hero_browse:"Browse listings", hero_stat_listings:"Active listings", hero_stat_districts:"Districts covered", hero_stat_users:"Users", hero_chip:"Admin verified"}
  };
